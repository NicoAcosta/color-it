...
class HostVC: MenuContainerViewController {
    ...
    private func contentControllers() -> [UIViewController] {
        let url         =   UrlVC             .storyboardViewController()
        let library     =   LibraryVC         .storyboardViewController()
        let collection  =   DataCollectionVC  .storyboardViewController()
        
        let controllers = [url, library, collection]
