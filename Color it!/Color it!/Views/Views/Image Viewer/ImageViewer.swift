...
class ImageViewerVC : MyViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        checkAndSaveName(textField: nameTextField)
...
extension ImageViewerVC : UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        checkAndSaveName(textField: textField)
        
        return true
    }
    
    
    func checkAndSaveName(textField: UITextField) {
