...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Fito",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Fito11DeleteAlert")
@interface DeleteAlert : UIAlertController
...
SWIFT_CLASS("_TtC4Fito16MyViewController")
...
SWIFT_CLASS("_TtC4Fito7OkAlert")
@interface OkAlert : UIAlertController
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Fito18UITextFieldPadding")
...
SWIFT_CLASS("_TtC4Fito17UITextViewPadding")
@interface UITextViewPadding : UITextView
...
@interface UIViewController (SWIFT_EXTENSION(Fito))
